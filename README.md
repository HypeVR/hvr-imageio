...
|---|---|---|---|
|[![Build Status](http://jenkins.hypevr.com/buildStatus/icon?job=hvr-imageio-build-unit-test-linux)](http://jenkins.hypevr.com/job/hvr-imageio-build-unit-test-linux/)|[![Build Status](http://jenkins.hypevr.com/buildStatus/icon?job=hvr-imageio-build-unit-test-windows)](http://jenkins.hypevr.com/job/hvr-imageio-build-unit-test-windows/)|[![Build Status](http://jenkins.hypevr.com/buildStatus/icon?job=hvr-imageio-cpplint)](http://jenkins.hypevr.com/job/hvr-imageio-cpplint/)|[![Build Status](http://jenkins.hypevr.com/buildStatus/icon?job=hvr-imageio-cmakelint)](http://jenkins.hypevr.com/job/hvr-imageio-cmakelint/)|
